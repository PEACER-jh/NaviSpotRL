...
from .navispotrl_marl_env_cfg import NavispotrlMarlEnvCfg


class NavispotrlMarlEnv(DirectMARLEnv):
    cfg: NavispotrlMarlEnvCfg

    def __init__(self, cfg: NavispotrlMarlEnvCfg, render_mode: str | None = None, **kwargs):
